...
export const Playlist = () => {
    ...
    const filteredSongs = allSongs.filter((songs) => {
        const matches = 
        songs.title.toLowerCase().includes(searchQuery.toLocaleLowerCase()) ||
        songs.artist.toLowerCase().includes(searchQuery.toLocaleLowerCase());

        const isAlreadyInPlaylist = selectedPlaylist?.songs.some(
            (playlistSong) => playlistSong.id === songs.id
        );
                        ...
                        <div className="playlist-item" key={key}>
                            ...
                            <div className="add-song-section">
                                <div className="search-container">
                                    <input 
                                        type="text" 
                                        placeholder="Seach songs to add..."
                                        value={
